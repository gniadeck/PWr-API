...
public interface JsosDataDAO {
     ...
     */
    List<JsosMessageFull> getStudentMessage(String login, String password, int pageNumber, Integer... messageIds) ;
     ...
     */
    List<JsosMessageShort> getStudentMessages(String login, String password, int pageNumber);
}
